...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.project-card, .skill-category, .contact-form');
...
// Efecto parallax suave en el hero (solo para elementos internos)
window.addEventListener('scroll', () => {
...
document.querySelectorAll('a[href^="#"]').forEach(anchor => {
    anchor.addEventListener('click', function (e) {
        ...
        if (target) {
            const offsetTop = target.offsetTop - 70; // Ajustar por la altura de la navbar
            window.scrollTo({
                top: offsetTop,
                behavior: 'smooth'
            });
...
// Efecto de hover mejorado para las cards de proyectos
